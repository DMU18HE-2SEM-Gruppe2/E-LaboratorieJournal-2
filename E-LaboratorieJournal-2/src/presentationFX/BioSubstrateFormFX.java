...
public class BioSubstrateFormFX {
	...
	public void start() {
		...
		// Tableview
		TableView<PreparationTable> preparationTable = new TableView<PreparationTable>();
		...
		Label lAddAftSterialize = factory.labelFactory("Eventuel tilsætning efter sterilisation", 0, 0, 0, 0, 14,
				false);
		...
		mainBox.getChildren().addAll(topGrid, sepTop, nameGrid, sepName, lPreparationTable, preparationTable,
				addPreparation, sepPreparation, mainGrid, sepMain, controlGrid, sepButton, btnBox);

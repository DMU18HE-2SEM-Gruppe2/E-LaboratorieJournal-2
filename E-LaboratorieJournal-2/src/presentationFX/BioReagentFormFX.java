...
public class BioReagentFormFX {
	...
	private TextField tfDate, tfTheme, tfAnalyzeTitle, tfReagentName, tfPhSetting, tfLiquid, tfTreatment, tfTag,
			tfDurability, tfStorage, tfComment;
	...
	public void start() {
		...
		mainBox.getChildren().addAll(topGrid, sepTop, lReference, preparationTable, addPreparation, sepTable, btmGrid,
				sepButtons, btnBox);
